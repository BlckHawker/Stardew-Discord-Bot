...
const getAllModsFromSpecificUser = async (client) => {
    try {
        ...
        for(let id of filteredModIds) {
            ...
            cachedNexusModReleaseChannel = await module.exports.getDiscordChannel(client, cachedNexusModReleaseChannel, process.env.NEXUS_MOD_RELEASE_CHANNEL_ID, channelName);
...
const getLatestICCCModRelease = async (client) => {
    ...
    try {
        ...
        //get the channel object to send the notification in
        cachedICCCNotifsChannel = await module.exports.getDiscordChannel(client, cachedICCCNotifsChannel, process.env.ICCC_NEXUS_MOD_NOTIFS_ID, channelName);
...
const getDiscordChannel = async (client, cachedChannelObject, channelId, channelName) => {
